      ...
      <div className="max-w-3xl mx-auto relative pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <div className="bg-surface-container p-6 rounded-xl group hover:bg-surface-container-high transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-headline font-bold text-lg">{t('welcome.backendTitle')}</h3>
            </div>
            <p className="text-xs text-on-surface-variant leading-relaxed">
              {t('welcome.backendBody')}
            </p>
          </div>
          <div className="bg-surface-container p-6 rounded-xl group hover:bg-surface-container-high transition-colors">
            <div className="flex items-center gap-3 mb-4">
              <span className="material-symbols-outlined text-secondary">palette</span>
              <h3 className="font-headline font-bold text-lg">{t('welcome.frontendTitle')}</h3>
            </div>
            <p className="text-xs text-on-surface-variant leading-relaxed">
              {t('welcome.frontendBody')}
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          <div className="syntax-comment text-xs mb-3">
            // {t('welcome.trackRecord')} <span className="syntax-function">education</span> {t('welcome.inTerminal')}
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div className="bg-surface-container rounded-xl p-4">
              <div className="flex items-center gap-2 mb-1">
                <span className="material-symbols-outlined text-secondary" style={{ fontSize: 16 }}>verified</span>
                <span className="syntax-comment text-[11px] uppercase tracking-wider">{t('welcome.certifications')}</span>
              </div>
            ...
            <div className="bg-surface-container rounded-xl p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="syntax-comment text-[11px] uppercase tracking-wider">{t('welcome.awards')}</span>
              </div>
              <div className="text-2xl font-bold text-primary font-headline">
            ...
            <div className="bg-surface-container rounded-xl p-4 col-span-2 sm:col-span-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="syntax-comment text-[11px] uppercase tracking-wider">{t('welcome.totalWins')}</span>
              </div>
              <div className="text-2xl font-bold text-primary font-headline">
